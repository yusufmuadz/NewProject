            ...
            children: [
              ...
              margin: EdgeInsets.only(top: 20),
                ...
                child: Row(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.all(width: 1, color: Color(0xFF005E51)),
                ...
                SizedBox(height: 50),
                Text("Kehadiran", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                Container(
                // height: 100,
              ...
              Container(
                            child: Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Text('Daftar Tugas', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                ...
                itemBuilder: (context, index){
                  return Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text("PKN", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                        InkWell(
                          onTap: (){},
      ...
      floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked,
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: Container(
            ...
            child: Icon(Icons.qr_code_scanner_outlined, size: 35, color: Colors.white)), tooltip: 'Absen'),
                ...
                child: InkWell(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Home',
                        style: TextStyle(color: Color.fromARGB(169, 171, 12, 115))
                      )
                    ],
                  ),
                ),
